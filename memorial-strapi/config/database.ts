...
export default ({ env }) => {
  ...
  const connections = {
    ...
    postgres: {
       ...
       * making it impossible to keep any open connections to the database (see the Tarn.js pool (https://knexjs.org/guide/#pool) settings used by Knex.js for more information).
       */
